...
public class ArticleService {
    ...
    public Page<ArticleDto> searchArticles(SearchType searchType, String searchKeyword, Pageable pageable) {
        ...
        return switch (searchType) {
            ...
            case WORK -> articleRepository.findByWorkContaining(searchKeyword, pageable).map(ArticleDto::from);
            case REGION -> articleRepository.findByRegionContaining(searchKeyword, pageable).map(ArticleDto::from);
        };
    }
    ...
    public void updateArticle(Long articleId, ArticleDto dto) {
        try {
            ...
            if (article.getUserAccount().equals(userAccount)) {
                ...
                article.setWork(dto.work());
                article.setRegion(dto.region());
                article.setReadCount(dto.readCount());
                article.setHeartCount(dto.heartCount());
            }
